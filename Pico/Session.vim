...
silent only
cd ~/Desktop/trabalhos/comp/Pico-Bruno-Felipe-Kaue/Pico
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +193 src/pico.y
badd +12 Testes/etapa5/fibonacci.pico
badd +18 src/Makefile
badd +2 makefile
badd +9 Testes/etapa5/run_tests.sh
badd +2 Testes/etapa5/fibonacci.tac
args src/pico.y
edit src/pico.y
...
silent! normal! zE
let s:l = 192 - ((25 * winheight(0) + 19) / 38)
...
exe '1resize ' . ((&lines * 38 + 26) / 52)
exe '2resize ' . ((&lines * 10 + 26) / 52)
tabedit Testes/etapa5/fibonacci.tac
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
18
normal! 0
tabedit Testes/etapa5/run_tests.sh
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
